...
class BaseSettings:
    ...
    model_fast: str = field(default_factory=lambda: env_str("AGENT_MODEL_FAST", "gemini-2.5-flash"))
    model_deep: str = field(default_factory=lambda: env_str("AGENT_MODEL_DEEP", "gemini-2.5-flash"))
